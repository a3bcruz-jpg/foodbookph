  ...
  const toggleFollow = (id: string) => {
    ...
    setNotice(
      following.includes(id)
        ? "Restaurant removed from following"
      ...
      <main className="page-grid">
        <aside className="sidebar">
          ...
          <button
            ...
            onClick={() =>
              setNotice("Owner dashboard is ready for your restaurant account")
            }
          >
            ...
            <span>
              ...
              <small>Claim or manage a place</small>
            </span>
        ...
        <aside className="right-rail">
          ...
          <div className="rail-card mustard-card">
            ...
            <p>
              Claim your listing, share what is new, and meet the people who
              love your food.
            </p>
            <button
              onClick={() =>
                setNotice("Claim flow opened for restaurant owners")
              }
            >
              Claim a restaurant <ChevronRight size={15} />
            </button>
          </div>
        </aside>
      </main>
      ...
      <section className="feature-band">
        ...
        <div className="feature-image">
          <img
            ...
            alt="A colorful Filipino meal shared at a table"
          />
    ...
    <>
      <div className="section-heading discover-heading">
        <div>
          ...
          <h1>
            {query ? `Results for “${query}”` : "Discover your next favorite"}
          </h1>
    ...
    <>
      <div className="section-heading discover-heading">
        <div>
          ...
          <h1>
            {query ? `Restaurants matching “${query}”` : "Restaurants"}
          </h1>
    ...
    <article className="restaurant-card">
      ...
      <div className="restaurant-details">
        ...
        <div className="restaurant-meta">
          <MapPin size={14} /> {restaurant.location} <span>·</span>{" "}
        ...
        <div className="restaurant-footer">
          ...
          <button
            ...
            className={following ? "following" : "follow-button"}
          >
...
function Composer({
  ...
  onClose: () => void;
  onPublish: (caption: string, image: string) => void;
}) {
    ...
    <div className="modal-backdrop" onClick={onClose}>
      <div className="composer" onClick={(event) => event.stopPropagation()}>
        ...
        <textarea
          ...
          placeholder="What did you eat, and would you go back?"
          autoFocus
        />
        ...
        <div className="composer-foot">
          ...
          <button
            ...
            onClick={() => onPublish(caption, image)}
          >
            Publish post
          </button>
        </div>
